...
use App\CustomLog\InscricaoLog\Contracts\Activity;
use App\CustomLog\InscricaoLog\Contracts\Activity as ActivityContract;
use App\CustomLog\InscricaoLog\Exceptions\InvalidConfiguration;
use App\CustomLog\InscricaoLog\Models\Activity as ActivityModel;
...
class ActivitylogServiceProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        ...
        ->hasCommand(CleanInscricaoActivitylogCommand::class);
    }
    ...
    {
        $activityModel = config('activitylog_inscricao.activity_model') ?? ActivityModel::class;
