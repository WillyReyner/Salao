...
use App\CustomLog\EditalLog\Exceptions\InvalidConfiguration;
use App\CustomLog\EditalLog\Models\Activity as ActivityModel;
...
class ActivitylogServiceProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        ...
        ->hasCommand(CleanEditalActivitylogCommand::class);
    }
    ...
    {
        $activityModel = config('activitylog_edital.activity_model') ?? ActivityModel::class;
