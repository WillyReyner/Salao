...
use App\CustomLog\TurmaLog\Exceptions\InvalidConfiguration;
use App\CustomLog\TurmaLog\Models\Activity as ActivityModel;
...
class ActivitylogServiceProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        ...
        ->hasCommand(CleanTurmaActivitylogCommand::class);
    }
    ...
    {
        $activityModel = config('activitylog_turma.activity_model') ?? ActivityModel::class;
