...
<template>
	<div class="tw-py-20">
		<div class="tw-flex tw-flex-0 tw-flex-col tw-justify-center tw-items-center tw-text-center">
			<h5 class="tw-text-lg tw-font-title tw-font-bold tw-text-green-700">ESTUDE CONOSCO</h5>
			<h5 class="tw-text-[42px] tw-font-title tw-font-bold tw-leading-[60px] lg:tw-max-w-2xl tw-text-navy-500 " >Conheça nosso cursos</h5>
		</div>
		<div class="tw-w-auto tw-mx-auto">
			<Carousel itemsToShow="3.95" :autoplay="5000" :itemsToShow="3.95" :wrapAround="true" :transition="500">
					...
					<div class="carousel__item">
						<q-card class="tw-rounded-2xl tw-w-[95%]">
							<div class="tw-w-auto tw-h-[200px] tw-flex tw-flex-1 tw-p-10">
								<img :src=logoEfg class=" tw-w-auto tw-fill-current tw-object-contain" alt=""/>
							</div>
		...
		<div class="tw-flex tw-flex-1 tw-items-center tw-justify-center tw-w-auto tw-gap-4">
			<PrimaryButton class="tw-text-white tw-bg-green-800 tw-h-10">VER TODOS OS CURSO</PrimaryButton>
			<PrimaryButton class="tw-text-primary tw-bg-white tw-border tw-border-primary tw-h-10">VER TODOS OS EDITAIS</PrimaryButton>
		</div>
	</div>
