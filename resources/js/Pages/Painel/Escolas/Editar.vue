            ...
            <div
                ...
                <div class="tw-flex md:tw-flex-row tw-flex-col md:tw-gap-2 tw-m-2 tw-pb-4">
                    <div class="tw-flex tw-flex-1 tw-flex-col">
                        ...
                        <q-select name="user_id" use-chips outlined multiple stack-label map-options
...
const form = useForm({
    ...
    user_id: props.escola.responsaveis.map(resp => ({ label: resp.user.name, value: resp.user.id }))
})

console.log('USERS',form.user_id)
