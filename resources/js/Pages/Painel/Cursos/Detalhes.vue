...
const opcoesCategoria = ["Aprendizagem", "Qualificação", "Capacitação", "Técnico", "Superior de Tecnologia", "Núcleo Altas Habilidades"];
const opcoesCargahoraria = ['40 Horas', '160 Horas', '240 Horas', '960 Horas', '1440 Horas']
const opcoesTag = props.tags.map(tag => ({ label: tag.nome, value: tag.id }))
...
const form = useForm({
	...
	area: props.curso.tags.length > 0 ? props.curso.tags.map((tags) => { return { label: tags.tag.nome, value: tags.tag.id } }) : [],
	subarea: props.curso.tags.length > 0 ? props.curso.tags.map((tags) => { return { label: tags.tag.nome, value: tags.tag.id } }) : [],
  ...
  <AuthenticatedLayout>
	  <div class="tw-flex tw-flex-1 tw-flex-col">
		  <div
			  ...
			  <div class="tw-flex md:tw-flex-row tw-flex-col md:tw-gap-4 tw-gap-2 ">
				  ...
				  <div class="tw-flex tw-flex-auto tw-flex-col">
					  <div class="tw-flex tw-flex-row tw-justify-between">
						  <div class="tw-flex tw-flex-col tw-mr-4 tw-w-3/4">
							  ...
							  <q-input id="nome" v-model="form.nome" type="text" disable
						  ...
						  <div class="tw-flex tw-flex-col tw-w-1/4">
							  ...
							  <q-select id="situacao" v-model="form.situacao" :options="opcoesSituacao" disable
					  ...
					  <div class="tw-flex tw-flex-0 tw-gap-4 tw-my-1">
						  <div class="tw-w-full">
							  ...
							  <q-input id="link_video_apresentacao" disable v-model="form.link_video_apresentacao" type="text" />
						  ...
						  <div class="tw-w-full">
							  ...
							  <q-select disable :options="opcoesCargahoraria" v-model="form.horas_curso" id="horas_curso" />
					  ...
					  <div class="tw-flex tw-flex-0 tw-gap-4 tw-my-2">
						  <div class="tw-w-full">
							  ...
							  <q-select disable :options="opcoesCategoria" v-model="form.nivel" id="categoria" />
							  <InputError class="tw-mt-2" :message="form.errors.nivel" />
						  </div>
						  <div class="tw-w-full">
							  <InputLabel for="faixa_etaria" value="Faixa Etária" required />
							  <q-select disable :options="opcoesCargahoraria" v-model="form.faixa_etaria" id="horas_curso" />
			  ...
			  <div class="tw-flex tw-flex-0 tw-gap-4 ">
				  <div class="tw-w-full">
			  ...
			  <div class="tw-flex tw-flex-col tw-pt-2 tw-justify-start">
				  ...
				  <q-input disable rows="4"
				           v-model="form.texto_site" type="text" />
				  <InputError class="tw-mt-2" :message="form.errors.texto_site" />
			  </div>
			  <div>
				  <q-toggle disable class="tw-text-neutral-600" left-label v-model="form.des_texto_site" label="Ocultar campo no site"  />
			  </div>
			  <div class="tw-flex tw-flex-col tw-pt-2">
				  ...
				  <q-input disable rows="4"
				           ...
				           v-model="form.disciplina" type="text" />
				  <InputError class="tw-mt-2" :message="form.errors.disciplina" />
			  </div>
			  <div>
				  <q-toggle disable class="tw-text-neutral-600" left-label v-model="form.des_disciplina" label="Ocultar campo no site"/>
			  </div>
			  <div class="tw-flex tw-flex-col tw-pt-2">
				  ...
				  <q-input disable rows="4"
				           ...
				           v-model="form.conteudo_programatico" type="text" />
				  <InputError class="tw-mt-2" :message="form.errors.conteudo_programatico" />
			  </div>
			  <div>
				  <q-toggle disable class="tw-text-neutral-600" left-label v-model="form.des_conteudo" label="Ocultar campo no site"/>
			  </div>
			  ...
			  <div class="tw-flex tw-flex-col tw-pt-2">
				  ...
				  <q-input disable rows="4"
				           class="tw-mt-1 tw-text-gray-700 tw-bg-white-50 tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-200 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm"
				           v-model="form.area_atuacao" type="text" />
				  <InputError class="tw-mt-2" :message="form.errors.area_atuacao" />
			  </div>
			  <div>
				  <q-toggle disable class="tw-text-neutral-600" left-label v-model="form.des_area_atuacao" label="Ocultar campo no site"/>
			  </div>
