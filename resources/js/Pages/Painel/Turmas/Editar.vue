		...
		<div class="tw-flex tw-flex-1 tw-flex-col">
			<div
				...
				<div
					...
					<h4 class=" tw-font-title tw-font-semibold">{{ form.nome }}</h4>
				</div>
				...
				<div class="tw-flex tw-flex-row tw-mt-8 md:tw-flex-row md:tw-gap-10 tw-gap-2 tw-m-2">
					<div class="tw-flex tw-flex-auto tw-w-80 tw-flex-col">
						...
						<q-select
							 v-model="form.edital_id"
							 :options="optionsEditais"
							 behavior="menu"
				...
				<div class="tw-flex md:tw-flex-row tw-flex-col md:tw-gap-10 tw-gap-2 tw-m-2">
					...
					<div class="tw-flex tw-flex-1 tw-flex-col">
						...
						<q-input id="vagas" v-model="form.vagas" autocomplete="vagas" autofocus class="tw-mt-1 tw-h-[52px] tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm" mask="######"
						         outlined
						         required/>
				...
				<div class="tw-flex tw-flex-row tw-mt-8 md:tw-flex-row md:tw-gap-10 tw-gap-2 tw-m-2 tw-pb-4">
					...
					<div class="tw-flex tw-flex-auto tw-w-0 tw-flex-col">
						...
						<q-input id="hora_inicio" v-model="form.hora_inicio" autocomplete="hora_inicio" autofocus class="tw-mt-1 tw-h-[52px] tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm" outlined
						         required
						         type="time"/>
					</div>
					<div class="tw-flex tw-flex-auto tw-w-0 tw-flex-col">
						<InputLabel for="hora_termino" value="Hora de Termino"/>
						<q-input id="hora_termino" v-model="form.hora_termino" autocomplete="hora_termino" autofocus class="tw-mt-1 tw-h-[52px] tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm"
						         outlined
						         type="time"/>
					</div>
					<div class="tw-flex tw-flex-auto tw-w-0 tw-flex-col">
				...
				<div>
					...
					<div v-if="form.habilitacao" class="tw-flex tw-flex-auto tw-flex-col tw-mt-5">
						<div class="tw-flex tw-flex-auto tw-flex-col tw-py-5">
							...
							<q-select v-model="form.habilitacoes_exigidas" :options="optionsHabilidade" behavior="menu" class="tw-mt-1 tw-h-full tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm" input-debounce="0"
					...
					<div v-if="form.accept" class="tw-flex tw-flex-auto tw-flex-col tw-mt-5">
						<div class="tw-flex tw-flex-auto tw-flex-col">
							...
							<div class="tw-flex tw-flex-row">
								<q-checkbox v-model="form.local_teste_online" label="Online" name="local_teste_online"
								            val="Online"/>
								<q-checkbox v-model="form.local_teste_presencial" label="Presencial" name="local_teste_presencial"
								            val="Presencial"/>
							</div>
						...
						<div class="tw-flex tw-flex-auto tw-flex-col tw-py-5">
							...
							<q-select v-model="form.testes_exigidos" :options="optionsDoc" behavior="menu" class="tw-mt-1 tw-h-full tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm" input-debounce="0"
							          multiple outlined use-chips use-input
							          @filter="filterFn">
								<template v-slot:no-option>
									<q-item>
						...
						<div v-if="form.local_teste_online" class="tw-flex tw-flex-auto tw-flex-col tw-w-[35%]">
							...
							<q-input id="data_limite_teste_online" v-model="form.data_limite_teste_online" autofocus class="tw-mt-1" emit-value map-options
							         outlined
							         type="date"/>
						</div>
						<div v-if="form.local_teste_presencial">
							...
							<div class="tw-flex tw-flex-auto md:tw-gap-2 tw-pb-4 tw-mt-4">
								<div class="tw-flex tw-flex-auto tw-w-60 tw-flex-col">
									...
									<q-select v-model="form.teste_presencial_escola" :options="optionsEscola" behavior="menu" class="tw-mt-1 tw-h-full tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm"
								...
								<div class="tw-flex tw-flex-auto tw-flex-col">
									...
									<q-input id="data_limite_teste_presencial" v-model="form.data_limite_teste_presencial" autofocus
									         class="tw-mt-1 tw-h-[52px] tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm"
									         emit-value map-options outlined type="date"/>
								</div>
								<div class="tw-flex tw-flex-auto tw-flex-col">
									<InputLabel for="hora_limite_teste_presencial" value="Horário do teste de aptidão"/>
									<q-input id="hora_limite_teste_presencial" v-model="form.hora_limite_teste_presencial" autocomplete="hora_limite_teste_presencial" autofocus class="tw-mt-1 tw-h-[52px] tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm"
									         outlined
									         required
									         type="time"/>
								</div>
								<div class="tw-flex tw-flex-auto tw-flex-col">
									...
									<q-input id="sala_teste_presencial" v-model="form.sala_teste_presencial" class="tw-mt-1 tw-block tw-w-full tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm"
									         outlined
						...
						<div v-if="form.accept_idade" class="tw-flex tw-flex-auto tw-flex-col tw-mt-5 tw-pb-4">
							<div class="tw-flex tw-flex-auto tw-flex-col">
								<InputLabel for="idade_minima" required
								            value="Idade Minima"/>
								<q-input id="idade_minima" v-model="form.idade_minima" class="tw-mt-1 tw-block tw-w-[10%] tw-border-gray-200 focus:tw-border-gray-500 focus:tw-ring-0 tw-rounded-lg tw-shadow-sm"
								         outlined
								         placeholder="Ex: 11 Anos" type="number"/>
...
console.log(props.turma.tipo_arquivos)
...
const form = useForm({
	...
	edital_id: props.turma.edital ? props.turma.edital.nome : null,
	curso_id: props.turma.curso_id ? props.turma.curso.nome : null,
	hora_inicio: props.turma.hora_inicio,
	hora_termino: props.turma.hora_termino,
	data_inicio: props.turma.data_inicio ? props.turma.data_inicio.split(' ')[0] : '',


	accept: props.turma.teste_aptidao === '1' ? true : false,
	habilitacao: props.turma.habilitacao === '1' ? true : false,
	local_teste_online: props.turma.teste_aptidao_local_online === '1' ? true : false,
	data_limite_teste_online: props.turma.teste_aptidao_data_online ? props.turma.teste_aptidao_data_online.split(' ')[0] : '',

	local_teste_presencial: props.turma.teste_aptidao_local_presencial === '1' ? true : false,
	teste_presencial_escola: props.turma.escola ? props.turma.escola.nome : null,
	data_limite_teste_presencial: props.turma.teste_aptidao_data_presencial ? props.turma.teste_aptidao_data_online.split(' ')[0] : '',
	hora_limite_teste_presencial: props.turma.teste_aptidao_hora_presencial,
	sala_teste_presencial: props.turma.teste_aptidao_sala_presencial,
	accept_idade: props.turma.teste_aptidao_idade === '1' ? true : false,
	idade_minima: props.turma.teste_aptidao_idade_minima,

	habilitacoes_exigidas: props.turma.tipo_arquivos_habilitacao.length > 0 ? props.turma.tipo_arquivos_habilitacao.map(tags => ({
		label: tags.habilitacao.nome,
		value: tags.habilitacao.id
	})) : [],

	testes_exigidos: props.turma.tipo_arquivos.length > 0 ? props.turma.tipo_arquivos.filter(tags => tags.tipo === '1').map(tags => ({
