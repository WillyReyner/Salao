...
const filteredEditais = ref(props.editais)
...
function removeItem(item) {
	...
	form.post(route('painel.editais.destroy'), {
		preserveScroll: true,
		onSuccess: (res) => {
			Notify.create({
...
const editaisForaDoPrazo = props.editais.filter((edital) => {
...
editaisForaDoPrazo.forEach((edital) => {
	...
	if (formR.situacao === 'Ativo') {
		formR.post(route('painel.editais.autoupdate', formR.id), {
			preserveScroll: true,
			forceFormData: true,
			onSuccess: (res) => {
				formR.reset();
        ...
        <div class="tw-flex tw-flex-1 tw-flex-col">
            <div
                ...
                <div
                    ...
                    <h4 class="tw-text-gray-900 tw-font-title tw-font-semibold">Editais Cadastrados</h4>
                    <div
                        ...
                        <Link :href="route('painel.editais.create')">
                                                ...
                                                <PrimaryButton class="tw-text-black tw-text-lg">...
                                                    <q-menu auto-close>
                                                        <div class="tw-flex tw-flex-col tw-gap-2">
                                                            <Link :href="route('painel.editais.show', props.row.id)"
                                                                title="Info"
                                                            ...
                                                            <Link v-if="hasPermission('Logs Editais')" :href="route('painel.editais.log', props.row.id)"
                                                                title="Info"
                                                                class="tw-flex hover:tw-bg-gray-100 flex-row tw-p-2 z-10 tw-justify-right tw-items-center">
                                                            ...
                                                            <Link v-if="hasPermission('Editar Editais')" :href="route('painel.editais.editar', props.row.id)"
                                                                title="Editar"
                                                                class="tw-flex hover:tw-bg-gray-100 flex-row tw-p-2 z-10 tw-justify-right tw-items-center">
