...
// node_modules/simple-vue-camera/dist/simple-vue-camera.umd.js
var require_simple_vue_camera_umd = __commonJS({
  "node_modules/simple-vue-camera/dist/simple-vue-camera.umd.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require_vue()) : typeof define === "function" && define.amd ? define(["vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.SimpleVueCamera = factory(global.vue));
      ...
      var script = vue.defineComponent({
        ...
        setup: function(props, _a) {
                ...
                switch (_a2.label) {
                  ...
                  case 1:
                    ...
                    return [2, devices2.filter(function(device) {
                      return kinds.includes(device.kind);
                    })];
                }
              });
            });
          ...
          var currentDeviceID = function() {
            if (!stream.value)
              return;
            var tracks = stream.value.getVideoTracks().map(function(track) {
          ...
          var snapshot = function(resolution, type, quality) {
            ...
            (_a2 = canvas.value.getContext("2d")) === null || _a2 === void 0 ? void 0 : _a2.drawImage(video.value, 0, 0, width, height);
            return new Promise(function(resolve) {
              var _a3;
              (_a3 = canvas.value) === null || _a3 === void 0 ? void 0 : _a3.toBlob(function(blob) {
                emit("snapshot", blob);
                resolve(blob);
              }, type, quality);
            });
          ...
          var resume = function() {
            var _a2;
            (_a2 = video.value) === null || _a2 === void 0 ? void 0 : _a2.play();
            emit("resumed");
          };
          var pause = function() {
            var _a2;
            (_a2 = video.value) === null || _a2 === void 0 ? void 0 : _a2.pause();
            emit("paused");
          };
          var stop = function() {
            var _a2;
            (_a2 = stream.value) === null || _a2 === void 0 ? void 0 : _a2.getTracks().forEach(function(track) {
              return track.stop();
            });
            emit("stopped");
          };
...
export default require_simple_vue_camera_umd();
...
simple-vue-camera/dist/simple-vue-camera.umd.js:
  (*! *****************************************************************************
      ...
      ***************************************************************************** *)
*/
//# sourceMappingURL=simple-vue-camera.js.map
