...
var QBtn = createComponent({ name: "QBtn", props: { ...useBtnProps, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] }, emits: ["click", "keydown", "mousedown", "keyup"], setup(e, { slots: t, emit: o }) {
  ...
  return onBeforeUnmount(() => {
    ...
    let o2 = [];
    void 0 !== e.icon && o2.push(h(QIcon, { name: e.icon, left: true !== e.stack && true === b.value, role: "img", "aria-hidden": "true" })), true === b.value && o2.push(h("span", { class: "block" }, [e.label])), o2 = hMergeSlot(t.default, o2), void 0 !== e.iconRight && false === e.round && o2.push(h(QIcon, { name: e.iconRight, right: true !== e.stack && true === b.value, role: "img", "aria-hidden": "true" }));
...
var QCircularProgress = createComponent({ name: "QCircularProgress", props: { ...useCircularCommonProps, value: { type: Number, default: 0 }, animationSpeed: { type: [String, Number], default: 600 }, indeterminate: Boolean }, setup(e, { slots: t }) {
  ...
  }), l = computed(() => true !== e.instantFeedback && true !== e.indeterminate ? { transition: `stroke-dashoffset ${e.animationSpeed}ms ease 0s, stroke ${e.animationSpeed}ms ease` } : ""), i = computed(() => diameter / (1 - e.thickness / 2)), r = computed(() => `${i.value / 2} ${i.value / 2} ${i.value} ${i.value}`), s = computed(() => between(e.value, e.min, e.max)), u = computed(() => e.max - e.min), c = computed(() => e.thickness / 2 * i.value), d = computed(() => {
    const t2 = (e.max - s.value) / u.value, o2 = true === e.rounded && s.value < e.max && t2 < 0.25 ? c.value / 2 * (1 - t2 / 0.25) : 0;
    return circumference * t2 + o2;
  });
  function p({ thickness: e2, offset: t2, color: o2, cls: n2, rounded: a2 }) {
  ...
  return () => {
    const o2 = [];
    void 0 !== e.centerColor && "transparent" !== e.centerColor && o2.push(h("circle", { class: `q-circular-progress__center text-${e.centerColor}`, fill: "currentColor", r: radius - c.value / 2, cx: i.value, cy: i.value })), void 0 !== e.trackColor && "transparent" !== e.trackColor && o2.push(p({ cls: "track", thickness: c.value, offset: 0, color: e.trackColor })), o2.push(p({ cls: "circle", thickness: c.value, offset: d.value, color: e.color, rounded: true === e.rounded ? "round" : void 0 }));
...
function useSlider({ updateValue: e, updatePosition: t, getDragging: o, formAttrs: n }) {
  const { props: a, emit: l, slots: i, proxy: { $q: r } } = getCurrentInstance(), s = useDark(a, r), u = useFormInject(n), c = ref(false), d = ref(false), p = ref(false), v = ref(false), m = computed(() => true === a.vertical ? "--v" : "--h"), f = computed(() => "-" + (true === a.switchLabelSide ? "switched" : "standard")), g = computed(() => true === a.vertical ? true === a.reverse : a.reverse !== (true === r.lang.rtl)), b = computed(() => true === isNaN(a.innerMin) || a.innerMin < a.min ? a.min : a.innerMin), y = computed(() => true === isNaN(a.innerMax) || a.innerMax > a.max ? a.max : a.innerMax), S = computed(() => true !== a.disable && true !== a.readonly && b.value < y.value), w = computed(() => {
    if (0 === a.step)
      return (e3) => e3;
    const e2 = (String(a.step).trim().split(".")[1] || "").length;
    return (t2) => parseFloat(t2.toFixed(e2));
  }), C = computed(() => 0 === a.step ? 1 : a.step), x = computed(() => true === S.value ? a.tabindex || 0 : -1), k = computed(() => a.max - a.min), _ = computed(() => y.value - b.value), q = computed(() => W(b.value)), T = computed(() => W(y.value)), P = computed(() => true === a.vertical ? true === g.value ? "bottom" : "top" : true === g.value ? "right" : "left"), $ = computed(() => true === a.vertical ? "height" : "width"), M = computed(() => true === a.vertical ? "width" : "height"), B = computed(() => true === a.vertical ? "vertical" : "horizontal"), E = computed(() => {
  ...
  function K(e2) {
    ...
    let l2 = t2 + e2 * (o2 - t2);
    if (n2 > 0) {
      const e3 = (l2 - b.value) % n2;
      l2 += (Math.abs(e3) >= n2 / 2 ? (e3 < 0 ? -1 : 1) * n2 : 0) - e3;
    }
    return l2 = w.value(l2), between(l2, b.value, y.value);
  }
  function W(e2) {
...
var QSlider = createComponent({ name: "QSlider", props: { ...useSliderProps, modelValue: { required: true, default: null, validator: (e) => "number" === typeof e || null === e }, labelValue: [String, Number] }, emits: useSliderEmits, setup(e, { emit: t }) {
  ...
  function y(t2) {
    if (!keyCodes$2.includes(t2.keyCode))
      return;
    stopAndPrevent(t2);
    const o2 = ([34, 33].includes(t2.keyCode) ? 10 : 1) * n.keyStep.value, a2 = ([34, 37, 40].includes(t2.keyCode) ? -1 : 1) * (true === n.isReversed.value ? -1 : 1) * (true === e.vertical ? -1 : 1) * o2;
    r.value = between(n.roundValueFn.value(r.value + a2), n.innerMin.value, n.innerMax.value), m();
  }
  return () => {
...
var QResizeObserver = createComponent({ name: "QResizeObserver", props: { debounce: { type: [String, Number], default: 100 } }, emits: ["resize"], setup(e, { emit: t }) {
  ...
  if (r.trigger = l, true === hasObserver) {
    let e2;
    const t2 = (n2) => {
...
var QColor = createComponent({ name: "QColor", props: { ...useDarkProps, ...useFormProps, modelValue: String, defaultValue: String, defaultView: { type: String, default: "spectrum", validator: (e) => ["spectrum", "tune", "palette"].includes(e) }, formatModel: { type: String, default: "auto", validator: (e) => ["auto", "hex", "rgb", "hexa", "rgba"].includes(e) }, palette: Array, noHeader: Boolean, noHeaderTabs: Boolean, noFooter: Boolean, square: Boolean, flat: Boolean, bordered: Boolean, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change"], setup(e, { emit: t }) {
  ...
  }), C = computed(() => ({ background: `hsl(${p.value.h},100%,50%)` })), x = computed(() => ({ top: `${100 - p.value.v}%`, [true === n.lang.rtl ? "right" : "left"]: `${p.value.s}%` })), k = computed(() => void 0 !== e.palette && 0 !== e.palette.length ? e.palette : palette), _ = computed(() => "q-color-picker" + (true === e.bordered ? " q-color-picker--bordered" : "") + (true === e.square ? " q-color-picker--square no-border-radius" : "") + (true === e.flat ? " q-color-picker--flat no-shadow" : "") + (true === e.disable ? " disabled" : "") + (true === a.value ? " q-color-picker--dark q-dark" : "")), q = computed(() => true === e.disable ? { "aria-disabled": "true" } : {}), T = computed(() => {
...
var QDate = createComponent({ name: "QDate", props: { ...useDatetimeProps, ...useFormProps, ...useDarkProps, multiple: Boolean, range: Boolean, title: String, subtitle: String, mask: { default: "YYYY/MM/DD" }, defaultYearMonth: { type: String, validator: yearMonthValidator }, yearsInMonthView: Boolean, events: [Array, Function], eventColor: [String, Function], emitImmediately: Boolean, options: [Array, Function], navigationMinYearMonth: { type: String, validator: yearMonthValidator }, navigationMaxYearMonth: { type: String, validator: yearMonthValidator }, noUnset: Boolean, firstDayOfWeek: [String, Number], todayBtn: Boolean, minimal: Boolean, defaultView: { type: String, default: "Calendar", validator: viewIsValid } }, emits: [...useDatetimeEmits, "rangeStart", "rangeEnd", "navigation"], setup(e, { slots: t, emit: o }) {
  ...
  }), le = computed(() => true === e.disable ? { "aria-disabled": "true" } : {});
  function ie() {
    const { year: e2, month: t2, day: o2 } = S.value, n2 = { ...w.value, year: e2, month: t2, day: o2 }, a2 = X.value[getMonthHash(n2)];
    void 0 !== a2 && false !== a2.includes(n2.day) || qe(n2), ue(n2.year, n2.month);
  }
  function re(e2) {
  ...
  function we(e2, t2, o2) {
    if (null !== W.value && e2 <= W.value.year && ((t2 < W.value.month || e2 < W.value.year) && (t2 = W.value.month), e2 = W.value.year), null !== Y.value && e2 >= Y.value.year && ((t2 > Y.value.month || e2 > Y.value.year) && (t2 = Y.value.month), e2 = Y.value.year), void 0 !== o2) {
...
var QItem = createComponent({ name: "QItem", props: { ...useDarkProps, ...useRouterLinkProps, tag: { type: String, default: "div" }, active: { type: Boolean, default: null }, clickable: Boolean, dense: Boolean, insetLevel: Number, tabindex: [String, Number], focused: Boolean, manualFocus: Boolean }, emits: ["click", "keyup"], setup(e, { slots: t, emit: o }) {
  ...
  function b(e2) {
    if (true === v.value && true === isKeyCode(e2, [13, 32])) {
...
var useValidateProps = { modelValue: {}, error: { type: Boolean, default: null }, errorMessage: String, noErrorIcon: Boolean, rules: Array, reactiveRules: Boolean, lazyRules: { type: [Boolean, String], default: false, validator: (e) => lazyRulesValues.includes(e) } };
function useValidate(e, t) {
  ...
  let r, s = 0;
  const u = computed(() => void 0 !== o.rules && null !== o.rules && 0 !== o.rules.length), c = computed(() => true !== o.disable && true === u.value && false === t.value), d = computed(() => true === o.error || true === a.value), p = computed(() => "string" === typeof o.errorMessage && 0 !== o.errorMessage.length ? o.errorMessage : l.value);
  function v() {
    s++, t.value = false, i.value = null, a.value = false, l.value = null, f.cancel();
  }
  function m(e2 = o.modelValue) {
    if (true === o.disable || false === u.value)
      return true;
    ...
    for (let t2 = 0; t2 < o.rules.length; t2++) {
      ...
      if ("function" === typeof n3 ? a2 = n3(e2, testPattern) : "string" === typeof n3 && void 0 !== testPattern[n3] && (a2 = testPattern[n3](e2)), false === a2 || "string" === typeof a2)
        return c2(true, a2), false;
      true !== a2 && void 0 !== a2 && d2.push(a2);
    }
    return 0 === d2.length ? (c2(false), true) : (t.value = true, Promise.all(d2).then((e3) => {
      if (void 0 === e3 || false === Array.isArray(e3) || 0 === e3.length)
        return n2 === s && c2(false), true;
      const t2 = e3.find((e4) => false === e4 || "string" === typeof e4);
      return n2 === s && c2(void 0 !== t2, t2), void 0 === t2;
    }, (e3) => {
      return n2 === s && (console.error(e3), c2(true)), false;
    }));
  }
  watch(() => o.modelValue, () => {
    i.value = true, true === c.value && false === o.lazyRules && f();
  }), watch(() => o.reactiveRules, (e2) => {
    true === e2 ? void 0 === r && (r = watch(() => o.rules, () => {
      true === c.value && true === i.value && "ondemand" !== o.lazyRules && f();
    }, { immediate: true })) : void 0 !== r && (r(), r = void 0);
  }, { immediate: true }), watch(() => o.lazyRules, (e2) => {
    false === e2 && true === c.value && true === i.value && f();
  }), watch(e, (e2) => {
    true === e2 ? null === i.value && (i.value = true === o.lazyRules) : true === c.value && (false === o.lazyRules || true === o.lazyRules && true === i.value) && f();
  });
  const f = debounce(m, 0);
  return onBeforeUnmount(() => {
    void 0 !== r && r(), f.cancel();
...
function getTargetUid(e, t) {
  return void 0 === e ? true === t ? `f_${uid$3()}` : void 0 : e;
}
...
function useFieldState({ requiredForAttr: e = true, tagProp: t } = {}) {
  const { props: o, attrs: n, proxy: a, vnode: l } = getCurrentInstance(), i = useDark(o, a.$q);
  return { requiredForAttr: e, tag: true === t ? computed(() => o.tag) : { value: "label" }, isDark: i, editable: computed(() => true !== o.disable && true !== o.readonly), innerLoading: ref(false), focused: ref(false), hasPopupOpen: false, splitAttrs: useSplitAttrs(n, l), targetUid: ref(getTargetUid(o.for, e)), rootRef: ref(null), targetRef: ref(null), controlRef: ref(null) };
}
function useField(e) {
  ...
  const { isDirtyModel: s, hasRules: u, hasError: c, errorMessage: d, resetValidation: p } = useValidate(e.focused, e.innerLoading), v = void 0 !== e.floatingLabel ? computed(() => true === t.stackLabel || true === e.focused.value || true === e.floatingLabel.value) : computed(() => true === t.stackLabel || true === e.focused.value || true === e.hasValue.value), m = computed(() => true === t.bottomSlots || void 0 !== t.hint || true === u.value || true === t.counter || null !== t.error), f = computed(() => {
    ...
    return true === t.disable && (o2["aria-disabled"] = "true"), o2;
  });
  function x() {
  ...
  watch(() => t.for, (t2) => {
    e.targetUid.value = getTargetUid(t2, e.requiredForAttr);
  });
  let Q = false;
  return onDeactivated(() => {
    ...
    true === isRuntimeSsrPreHydration.value && true === e.requiredForAttr && void 0 === t.for && (e.targetUid.value = `f_${uid$3()}`), true === t.autofocus && l.focus();
  }), onBeforeUnmount(() => {
    ...
    return h(e.tag.value, { ref: e.rootRef, class: [g.value, a.class], style: a.style, ...o2 }, [void 0 !== n.before ? h("div", { class: "q-field__before q-field__marginal row no-wrap items-center", onClick: prevent }, n.before()) : null, h("div", { class: "q-field__inner relative-position col self-stretch" }, [h("div", { ref: e.controlRef, class: b.value, tabindex: -1, ...e.controlEvents }, $()), true === m.value ? B() : null]), void 0 !== n.after ? h("div", { class: "q-field__after q-field__marginal row no-wrap items-center", onClick: prevent }, n.after()) : null]);
  };
}
var QField = createComponent({ name: "QField", inheritAttrs: false, props: { ...useFieldProps, tag: { type: String, default: "label" } }, emits: useFieldEmits, setup() {
  return useField(useFieldState({ requiredForAttr: false, tagProp: true }));
} });
...
var QRange = createComponent({ name: "QRange", props: { ...useSliderProps, modelValue: { type: Object, default: () => ({ min: null, max: null }), validator: (e) => "min" in e && "max" in e }, dragRange: Boolean, dragOnlyRange: Boolean, leftLabelColor: String, leftLabelTextColor: String, rightLabelColor: String, rightLabelTextColor: String, leftLabelValue: [String, Number], rightLabelValue: [String, Number], leftThumbColor: String, rightThumbColor: String }, emits: useSliderEmits, setup(e, { emit: t }) {
  ...
  function T(t2, o2 = n.dragging.value) {
    ...
    switch (o2.type) {
      ...
      case dragType.MAX:
        ...
        break;
      case dragType.RANGE:
        const e2 = u2 - o2.offsetRatio, t3 = between(o2.ratioMin + e2, n.innerMinRatio.value, n.innerMaxRatio.value - o2.rangeRatio), a2 = c2 - o2.offsetModel, i2 = between(o2.valueMin + a2, n.innerMin.value, n.innerMax.value - o2.rangeValue);
        l2 = { minR: t3, maxR: t3 + o2.rangeRatio, min: n.roundValueFn.value(i2), max: n.roundValueFn.value(i2 + o2.rangeValue) }, n.focus.value = "both";
        break;
    }
  ...
  function P(t2) {
    ...
    if ("both" === n.focus.value) {
      const e2 = s.value.max - s.value.min, t3 = between(n.roundValueFn.value(s.value.min + a2), n.innerMin.value, n.innerMax.value - e2);
      s.value = { min: t3, max: n.roundValueFn.value(t3 + e2) };
    } else {
      if (false === n.focus.value)
        return;
      {
        const e2 = n.focus.value;
        s.value = { ...s.value, [e2]: between(n.roundValueFn.value(s.value[e2] + a2), "min" === e2 ? n.innerMin.value : s.value.min, "max" === e2 ? n.innerMax.value : s.value.max) };
      }
    }
    _();
  }
...
var QSelect = createComponent({ name: "QSelect", inheritAttrs: false, props: { ...useVirtualScrollProps, ...useFormProps, ...useFieldProps, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: validateNewValueMode }, mapOptions: Boolean, emitValue: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: String, transitionHide: String, transitionDuration: [String, Number], behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: { type: [Number, String], default: void 0 }, onNewValue: Function, onFilter: Function }, emits: [...useFieldEmits, "add", "remove", "inputValue", "newValue", "keyup", "keypress", "keydown", "filterAbort"], setup(e, { slots: t, emit: o }) {
  ...
  const C = ref(null), x = ref(null), k = ref(null), _ = ref(null), q = ref(null), T = useFormInputNameAttr(e), P = useKeyComposition($e), $ = computed(() => Array.isArray(e.options) ? e.options.length : 0), M = computed(() => void 0 === e.virtualScrollItemSize ? true === e.optionsDense ? 24 : 48 : e.virtualScrollItemSize), { virtualScrollSliceRange: B, virtualScrollSliceSizeComputed: E, localResetVirtualScroll: Q, padVirtualScroll: A, onVirtualScrollEvt: L, scrollTo: O, setVirtualScrollSize: F } = useVirtualScroll({ virtualScrollLength: $, getVirtualScrollTarget: _e, getVirtualScrollEl: ke, virtualScrollItemSizeComputed: M }), R = useFieldState(), D = computed(() => {
    ...
    return e.options.slice(t2, o2).map((o3, n2) => {
      const i2 = true === ie.value(o3), s2 = true === be(o3), u2 = t2 + n2, c2 = { clickable: true, active: s2, activeClass: ne.value, manualFocus: true, focused: false, disable: i2, tabindex: -1, dense: e.optionsDense, dark: I.value, role: "option", "aria-selected": true === s2 ? "true" : "false", id: `${R.targetUid.value}_${u2}`, onClick: () => {
        ve(o3);
      } };
      return true !== i2 && (r.value === u2 && (c2.focused = true), true === a.platform.is.desktop && (c2.onMousemove = () => {
        true === l.value && me(u2);
      })), { index: u2, opt: o3, html: W.value(o3), label: le.value(o3), selected: c2.active, focused: c2.focused, toggleOption: ve, setOptionIndex: me, itemProps: c2 };
    });
...
function addNotification(e, t, o) {
  ...
  if (true !== e.ignoreDefaults && Object.assign(a, defaults), false === isObject(e) && (a.type && Object.assign(a, notifTypes[a.type]), e = { message: e }), Object.assign(a, notifTypes[e.type || a.type], e), "function" === typeof a.icon && (a.icon = a.icon(t)), a.spinner ? (true === a.spinner && (a.spinner = QSpinner), a.spinner = markRaw(a.spinner)) : a.spinner = false, a.meta = { hasMedia: Boolean(false !== a.spinner || a.icon || a.avatar), hasText: hasContent(a.message) || hasContent(a.caption) }, a.position) {
    ...
    a.position = "bottom";
  if (true === invalidTimeoutValues.includes(a.timeout))
    a.timeout = 5e3;
  else {
    const t2 = Number(a.timeout);
    if (isNaN(t2) || t2 < 0)
      return logError("wrong timeout", e);
    a.timeout = Number.isFinite(t2) ? t2 : 0;
  }
...
var Quasar = { version: "2.14.2", install(e, t, o) {
